...
export const translations = {
  fr: {
    ...
    sessionFinishedBadge: "Objectif atteint !",
    ...
    methodDesc: "Une expérience de dikr apaisante basée sur le rythme et le temps.",
    ...
    shareTitle: "Dikr App - Ton compagnon pour un rappel constant.",
    shareDesc: "Découvre notre compteur rythmique sans publicité et hors-ligne pour t'aider à garder ta concentration, où que tu sois.",
    ...
    fatwaDisclaimer: "Note : Le compte sur les phalanges reste la meilleure des méthodes. L'outil rythmique ici présent n'est qu'un moyen technique pour aider à la concentration et éviter la distraction.",
    ...
    saveBtn: "Enregistrer",
    addManualEntry: "Ajout manuel",
    manualEntryTitle: "Ajout manuel",
    dikrLabel: "Dikr",
  ...
  en: {
    ...
    sessionFinishedBadge: "Target reached!",
    ...
    methodDesc: "A soothing, time-based dikr experience focused on rhythm.",
    ...
    shareApp: "Share App",
    shareAppShort: "Share",
    shareTitle: "Dikr App - Your companion for constant remembrance.",
    shareDesc: "Discover our rhythmic counter, ad-free and offline, to help you maintain your concentration wherever you are.",
    ...
    fatwaDisclaimer: "Note: Counting on the fingers remains the best method. The rhythmic tool provided here is merely a technical aid to help concentration and avoid distraction.",
  ...
  ar: {
    ...
    sessionFinishedBadge: "تم الوصول للهدف!",
    ...
    shareTitle: "تطبيق الذكر - رفيقك لذكر الله الدائم.",
    shareDesc: "اكتشف عدادنا الإيقاعي المساعد، بدون إعلانات ويعمل بدون إنترنت، للحفاظ على تركيزك في الذكر أينما كنت.",
    ...
    fatwaDisclaimer: "تنبيه: العقد بالأنامل هو الأفضل. الأداة الإيقاعية هنا هي مجرد مساعدة تقنية لدفع تشتت الذهن وليست طريقة لها فضل خاص في ذاتها.",
    ...
    saveBtn: "حفظ",
    addManualEntry: "إضافة يدوية",
    manualEntryTitle: "إضافة يدوية",
    dikrLabel: "الذكر",
    selectDikr: "اختر",
    countLabel: "العدد",
