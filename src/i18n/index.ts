...
export const translations = {
  fr: {
    ...
    fatwaDisclaimer: "Note : Le compte sur ses doigts reste la meilleure des méthodes. L'outil rythmique ici présent n'est qu'un moyen technique pour aider à la concentration et éviter la distraction.",
